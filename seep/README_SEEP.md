...
1.	From the Windows Search Menu: type 'Geostudio', one of the items under 'Apps' should be 'GeoStudio 2025.1.0 API Folder'. Click it to open an explorer window to the 'API' folder.
...
3. 	Install the Requirements File: 
		Run the following command in your desired Python environment to install the libraries:
			...
			example: pip install -r "C:\Program Files\Seequent\GeoStudio 2025.1\API\requirements.txt"
		Note: the gsi-2025.1.0-py3-none-any.whl file could have been installed directly; however, additional libraries may be added to the requirements.txt file in a future release.
